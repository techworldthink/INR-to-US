...
class Convert:
    def __init__(self, master):
        ...
        #labelled frames
        self.frame_left          =  LabelFrame(master,text="INR to US Dollar",labelanchor="n",bg="gray",bd=10,fg="white",font=self.label_frame_font)
        self.frame_right     =  LabelFrame(master,text="US Dollar to INR",labelanchor="n",bg="gray",bd=10,fg="white",font=self.label_frame_font)
        ...
        self.label_frame_2 = Label(self.frame_left,text="MINIMUM WORD LENGTH",padx=10,pady=10,bg="white",fg="black",font=self.frame2_font)
        self.label2_frame_2 = Label(self.frame_left,text="MAXIMUM WORD LENGTH",padx=10,pady=10,bg="white",fg="black",font=self.frame2_font)
        ...
        self.frame2_btn = Button(self.frame_left,text="Calculate",height = 2, width = 8,bg="#232526",fg="white",command=lambda:INRtoUS())
        ...
        self.entry2_frame_2.grid(row=1,column=3,sticky="w",padx=50,pady=20)
        self.frame2_btn.grid(row=2,column=2)

        #componants for frame 2
        self.label_frame_3 = Label(self.frame_right,text="MINIMUM WORD LENGTH",padx=10,pady=10,bg="white",fg="black",font=self.frame2_font)
        self.label2_frame_3 = Label(self.frame_right,text="MAXIMUM WORD LENGTH",padx=10,pady=10,bg="white",fg="black",font=self.frame2_font)
        ...
        self.frame3_btn = Button(self.frame_right,text="Calculate",height = 2, width = 8,bg="#232526",fg="white",command=lambda:UStoINR())
